...
import Poster5 from "./imgsource/nm.jpg"
...
const Movie5 = () => {
    ...
    return (
                <div className="Mitems" onClick={changeStyle}>
                    <Poster src={Poster5}/>
                    <MovieTitle>Nomadland</MovieTitle>
                    <MovieGenre>Drama, Indie</MovieGenre>
                    <MovieYear>2021</MovieYear>
                    <div className={style}>
                        <Modal>
                            <Modalimg src={Poster5}/>
                            <div>
                                <Modalh4>Nomadland</Modalh4>
                                <Modalh5>2021</Modalh5>
                                <Modalh6>Drama, Indie</Modalh6>
                                <Modalp>A woman in her sixties who, after losing everything in the Great Recession, embarks on a journey through the American West, living as a van-dwelling modern-day nomad.</Modalp>
