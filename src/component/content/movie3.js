...
import Poster3 from "./imgsource/lb.jpg"
...
const Movie3 = () => {
    ...
    return (
                <div className="Mitems" onClick={changeStyle}>
                    <Poster src={Poster3}/>
                    <MovieTitle>Lady Bird</MovieTitle>
                    <MovieGenre>Drama</MovieGenre>
                    <MovieYear>2017</MovieYear>
                    <div className={style}>
                        <Modal>
                            <Modalimg src={Poster3}/>
                            <div>
                                <Modalh4>Lady Bird</Modalh4>
                                <Modalh5>2017</Modalh5>
                                <Modalh6>Drama</Modalh6>
                                <Modalp>Christine Lady Bird McPherson, a teenage girl faces a lot of ups and downs in her relationships during her senior year in high school.</Modalp>
