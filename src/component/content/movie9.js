...
import Poster9 from "./imgsource/MV5BMjI1NDYzNzY2Ml5BMl5BanBnXkFtZTgwODQwODczNTM@._V1_.jpg"
...
const Movie9 = () => {
    ...
    return (
                <div className="Mitems" onClick={changeStyle}>
                    <Poster src={Poster9}/>
                    <MovieTitle>The Greatest Showman</MovieTitle>
                    <MovieGenre>Musical, Family</MovieGenre>
                    <MovieYear>2017</MovieYear>
                    <div className={style}>
                        <Modal>
                            <Modalimg src={Poster9}/>
                            <div>
                                <Modalh4>The Greatest Showman</Modalh4>
                                <Modalh5>2017</Modalh5>
                                <Modalh6>Musical, Family</Modalh6>
                                <Modalp>PT Barnum becomes a worldwide sensation in the show business. His imagination and innovative ideas take him to the top of his game.</Modalp>
