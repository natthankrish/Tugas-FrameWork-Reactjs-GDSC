...
import Poster4 from "./imgsource/gg.jpg"
...
const Movie4 = () => {
    ...
    return (
                <div className="Mitems" onClick={changeStyle}>
                    <Poster src={Poster4}/>
                    <MovieTitle>The Great Gatsby</MovieTitle>
                    <MovieGenre>Drama</MovieGenre>
                    <MovieYear>2013</MovieYear>
                    <div className={style}>
                        <Modal>
                            <Modalimg src={Poster4}/>
                            <div >
                                <Modalh4>The Great Gatsby</Modalh4>
                                <Modalh5>2013</Modalh5>
                                <Modalh6>Drama</Modalh6>
                                <Modalp>Nick Carraway, a World War I veteran who moves to New York with the hope of making it big, finds himself attracted to Jay Gatsby and his flamboyant lifestyle.</Modalp>
