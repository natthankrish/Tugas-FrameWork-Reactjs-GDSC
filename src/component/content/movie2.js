...
import Poster2 from "./imgsource/PP.jpg"
...
const Movie2 = () => {
    ...
    return (
                <div className="Mitems" onClick={changeStyle}>
                    <Poster src={Poster2}/>
                    <MovieTitle>Pride & Prejudice</MovieTitle>
                    <MovieGenre>Drama, Romance</MovieGenre>
                    <MovieYear>2005</MovieYear>
                    <div className={style} >
                        <Modal>
                            <Modalimg src={Poster2}/>
                            <div >
                                <Modalh4>Pride & Prejudice</Modalh4>
                                <Modalh5>2005</Modalh5>
                                <Modalh6>Drama, Romance</Modalh6>
                                <Modalp>Mrs Bennet insists that her daughters find rich husbands and settle down. When a wealthy bachelor starts living near them, Mrs Bennet's happiness knows no bounds.</Modalp>
